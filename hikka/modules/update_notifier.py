...
class UpdateNotifierMod(loader.Module):
    """Tracks latest FTU releases, and notifies you, if update is required"""

    strings = {
        "name": "UpdateNotifier",
        "update_required": (
            "🌘 <b>FTU Update available!</b>\n\nNew FTU version released.\n🔮"
            " <b>FTU <s>{}</s> -> {}</b>\n\n{}"
        ),
        "more": "\n<i><b>🎥 And {} more...</b></i>",
    ...
    strings_ru = {
        "update_required": (
            "🌘 <b>Доступно обновление FTU!</b>\n\nОпубликована новая версия FTU.\n🔮"
            " <b>Hikka <s>{}</s> -> {}</b>\n\n{}"
        ),
        "more": "\n<i><b>🎥 И еще {}...</b></i>",
