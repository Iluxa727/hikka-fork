...
class QuickstartMod(loader.Module):
    ...
    strings = {
        "name": "Quickstart",
        "base": """🦊🇬🇧 <b>Hello.</b> You've just installed <b>FTU</b> userbot.
...
💡 <b>FTU supports modules from Friendly-Telegram and GeekTG and Hikka as well as its own ones.</b>""",
        "okteto": (
        ...
        "railway": (
            ...
            " <b>FTU will be frozen</b>. Next month <b>you will need to go to"
...
💡 <b>FTU поддерживает модули из Friendly-Telegram и GeekTG и Hikka а также свои собственные.</b>
""",
        "okteto": (
